...
int main()
{
    ...
    pid.Init(0.2, 0.004, 3); //PID from the Lesson
    std::cout << "Initial parameters: " << std::endl;
    std::cout << "Kp: " << pid.getKp() << std::endl;
    std::cout << "Ki: " << pid.getKi() << std::endl;
    std::cout << "Kd: " << pid.getKd() << std::endl;
    std::cout << "Taken from the Lesson" <<std::endl;
    std::cout << "By Sebastian Thrun." <<std::endl;
    std::cout << std::endl;
        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    // DEBUG
                    //                std::cout << "CTE: " << cte << " Steering Value: " << steer_value << " | rmse: " << sqrt(pid.currentError/pid.counter) << std::endl;
                    json msgJson;
